...
const Skills = () => {
    ...
    return (
        ...
        <section id="skills" class="skills section-bg services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row skills-content">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="progress">
                            ...
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" style={{width: "90%"}} role="progressbar"  aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="progress">
                            <span class="skill">HTML/CSS/Bootstrap<i class="val">90%</i></span>
                            <div class="progress-bar-wrap">
                        ...
                        <div class="progress">
                            <span class="skill">MERN <i class="val">80%</i></span>
                            <div class="progress-bar-wrap">
                                <div class="progress-bar" role="progressbar" style={{width: "80%"}} aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12  d-flex justify-content-around" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box iconbox-red w-50">
                            <div class="icon">
                            ...
                            <h4><a href="#">Other Skills</a></h4>
                            <p> REST API, JUnit, Vue.js, Kafka, Git.</p>
                        </div>
                        <div class="icon-box iconbox-teal w-50">
                            <div class="icon">
                                <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
