    ...
    <>
      ...
      <header id="header" className="d-flex flex-column justify-content-center">
        <nav className="nav-menu">
          ...
          <Scrollspy items={['hero', 'about', 'skills', 'resume', 'portfolio', 'contact']} currentClassName="active" data>
            ...
            <li><a href="#resume"><i className="bx bx-book-content"></i> <span>Resume</span></a></li>
